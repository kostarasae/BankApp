    ...
    return (
        <Card>
            ...
            <div className="w-[380px] max-w-full h-[220px] mx-auto my-6 rounded-[18px] text-white p-6 box-border flex flex-col justify-between relative overflow-hidden font-mono"
                ...
                <div className="text-xl text-center tracking-[4px]">4728 •••• •••• 3891</div>
                <div className="flex justify-between items-end">
                    <div>
                        <div className="text-[9px] uppercase opacity-70 mb-[3px]">Κάτοχος Κάρτας</div>
                        <div className="text-sm tracking-wide">{holder || '—'}</div>
                    </div>
                    <div>
                        <div className="text-[9px] uppercase opacity-70 mb-[3px]">Λήξη</div>
                        <div>12/28</div>
                    </div>
                </div>
            </div>
