...
export async function uploadIdFile(uuid, file) {
    try {
...
export async function deposit(iban, description, amount) {
    try {
...
export async function withdraw(myIban, description, amount) {
    try {
...
export async function transfer(myIban, toIban, description, amount) {
    try {
