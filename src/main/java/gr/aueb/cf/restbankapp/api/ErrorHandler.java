package gr.aueb.cf.restbankapp.core;
...
public class ErrorHandler extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler(AccountNotReportableException.class)
    public ResponseEntity<ErrorResponseDTO> handleAccountNotReportableException(AccountNotReportableException e) {
        log.warn("Account type is not reportable. Message={}", e.getMessage());
        return ResponseEntity
